...
class ChatList extends StatefulWidget {
  ...
  /// Used for create sticky items on top with small amount of message.
  /// Don't use with huge items count.
  final int? stickyOnTopItemCount;
  ...
  Widget build(BuildContext context) =>
      NotificationListener<ScrollNotification>(
        ...
        child: CustomScrollView(
          ...
          reverse: true,
          shrinkWrap: widget.items.length <= (widget.stickyOnTopItemCount ?? 0),
          slivers: [
